"""
train_cfr_uniform_cap20_pruned26.py

Monte Carlo CFR trainer with pruning for the simplified stop/draw game.
...
Pruning rule:
- If active player's hand sum is greater than 26, force DRAW.
  These forced states are not stored as CFR info-set rows.
...
def cfr(
    ...
    # Pruning rule: if your hand is clearly bad, do not create a CFR node.
    # Just force DRAW and continue. Since DRAW can only improve or keep your hand,
    # stopping with sum > 26 is not worth spending training time on.
